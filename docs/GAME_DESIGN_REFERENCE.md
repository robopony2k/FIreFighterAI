...
- Static hydrology treats rivers, inland lakes, lake outlets, and waterfalls as one generated water network. Wind-shaped rainfall/runoff biases where river-fed inland basins become lakes; accepted lake, river, and waterfall water tiles remain non-burnable water sources with full moisture and zero fuel.
