...
export const rgbString = (color) => `rgb(${Math.round(color.r)}, ${Math.round(color.g)}, ${Math.round(color.b)})`;
/**
 ...
 */
export const mixRgbTo = (out, a, b, t) => {
    out.r = a.r + (b.r - a.r) * t;
    out.g = a.g + (b.g - a.g) * t;
    out.b = a.b + (b.b - a.b) * t;
};
 ...
 * @returns A new RGB object.
 */
export const scaleRgb = (color, factor) => ({
 ...
 * @returns A new RGB object.
 */
export const lighten = (color, amount) => mixRgb(color, { r: 255, g: 255, b: 255 }, clamp(amount, 0, 1));
/**
 * Darkens a color by mixing it with black.
 * @returns A new RGB object.
 */
export const darken = (color, amount) => mixRgb(color, { r: 0, g: 0, b: 0 }, clamp(amount, 0, 1));
