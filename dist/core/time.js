...
export function getDayNightFactor(dayValue, settings) {
...
export function getFireSeasonIntensity(dayValue, settings) {
...
export function getFireSpreadScale(dayValue, settings) {
