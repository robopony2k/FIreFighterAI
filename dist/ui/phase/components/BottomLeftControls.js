export const createBottomLeftControls = () => {
  ...
  `;
    ...
    const pauseButton = speedRow.querySelector('[data-action="pause"]');
    const speedButtons = Array.from(speedRow.querySelectorAll("[data-speed-index]"));
    return {
        element,
        update: (data) => {
