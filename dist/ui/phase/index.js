...
export const initPhaseUI = (container) => {
    ...
    const sync = (world) => {
        ...
        state.setForecast(world.climateForecast ?? null, world.climateForecastDay ?? 0, Math.max(0, world.climateForecastStart ?? 0), world.climateTimeline?.daysPerYear ?? 360, forecastMeta);
