...
export const FIRE_SIM_LAB_SPEED_OPTIONS = [...INCIDENT_TIME_SPEED_OPTIONS] as const;

export const DEFAULT_FIRE_SIM_LAB_SPEED =
  FIRE_SIM_LAB_SPEED_OPTIONS[DEFAULT_INCIDENT_TIME_SPEED_INDEX] ?? FIRE_SIM_LAB_SPEED_OPTIONS[1] ?? 0.5;
