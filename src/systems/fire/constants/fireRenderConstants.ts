...
export const FIRE_CROSS_MAX_INSTANCES = 1024;
export const SMOKE_MAX_INSTANCES = 1400;
export const EMBER_MAX_INSTANCES = 700;
export const SPARK_STREAK_MAX_INSTANCES = 900;
export const SPARK_POINT_MAX_INSTANCES = 1800;
...
export const SMOKE_INITIAL_AGE01 = 0.06;
...
export const FIRE_FX_NORMAL_SMOKE_DENSITY_SCALE = 0.24;
export const FIRE_FX_NORMAL_MAX_SMOKE_RENDER_CAP = 160;
export const FIRE_FX_NORMAL_SMOKE_SPAWN_FRAME_CAP = 28;
...
export const FIRE_FRONT_MAX_INSTANCES = 1024;
...
export const SMOKE_EMISSION_DENSITY_SCALE = 1;
export const SMOKE_LIFETIME_SCALE = 2;
