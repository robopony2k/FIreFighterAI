...
export const sampleSeasonalCloudAdvection = (
  ...
  return {
    nearX: seedX - travelX * input.nearDriftPerDay,
    nearY: seedY - travelY * input.nearDriftPerDay,
    farX: seedX * 0.61 - travelX * input.farDriftPerDay + 0.19,
    farY: seedY * 0.61 - travelY * input.farDriftPerDay - 0.11,
    morphTimeDays: careerDay + hash01(stableSeed, 95.83) * 23
  };
};
