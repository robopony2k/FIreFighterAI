...
export const ENABLE_GRASS_DETAIL_FX = false;
...
export const EDGE_WATER_VARIANCE = 0.7;
export const EDGE_WATER_VARIANCE_REF = 64;
export const EDGE_WATER_OFFSET_CAP = 18;
export const EDGE_WATER_JITTER_CAP = 6;
export const LAND_CENTER_HEIGHT_SCALE = 1.1;
export const BASIN_DEPTH_SCALE = 0.8;
export const LAND_CENTER_INSET_FRACTION = 0.05;
export const EDGE_LAND_ATTENUATION = 0.4;
export const EDGE_LAND_EXPONENT = 1.6;
export const EDGE_WATER_BASE_OFFSET = 0.0004;
export const LAND_MASS_BIAS_FRACTION = 0.42;
export const LAND_MASS_BIAS_STRENGTH = 0.16;
export const ELEVATION_MACRO_WEIGHT = 0.7;
export const ELEVATION_DETAIL_WEIGHT = 0.3;
export const ELEVATION_MACRO_SCALE = 1.2;
export const WATER_BASELINE_ELEV = 0.00;
...
export const MOISTURE_ELEV_DRY_RANGE = 0.35;
export const MOISTURE_GAMMA = 1.2;
export const MOISTURE_BFS_CHUNK = 25000;
