...
export const bindPhaseUi = ({
  ...
  const startMenuSimLabButton = document.getElementById("startMenuSimLab") as HTMLButtonElement | null;
  ...
  if (startMenuSimLabButton) {
    listenElement(startMenuSimLabButton, "click", () => {
      void onSimLab();
    });
  }
